...
urlpatterns = patterns('',
   ...
   # url(r'^modadmin/adminuser/moduser/mod/$', views.moduser, name="moduser"),
    ...
    url(r'^(?P<proyecto_id>\d+)/modproyecto/accionesproyecto/projectDetalles$', views.projectDetalles, name='projectDetalles'),
    ...
    url(r'^(?P<proyecto_id>\d+)/modproyecto/accionesproyecto/adminhu/(?P<hu_id>\d+)/principal/$', views.huprincipal, name="huprincipal"),
    url(r'^(?P<proyecto_id>\d+)/modproyecto/accionesproyecto/adminhu/(?P<hu_id>\d+)/log/$', views.hulog, name="hulog"),
    url(r'^(?P<proyecto_id>\d+)/modproyecto/accionesproyecto/adminhu/(?P<hu_id>\d+)/editar/$', views.editarHu, name="editarHu"),
    url(r'^(?P<proyecto_id>\d+)/modproyecto/accionesproyecto/adminhu/(?P<hu_id>\d+)/finalizarHu/$', views.finalizarHu, name="finalizarHu"),
    ...
    url(r'^(?P<proyecto_id>\d+)/modproyecto/accionesproyecto/adminhu/(?P<hu_reg_id>\d+)/registro/ver/$', views.verregistroHu, name="verregistroHu"),
    ...
    url(r'^(?P<proyecto_id>\d+)/(?P<sprint_id>\d+)/(?P<hu_id>\d+)/modproyecto/accionesproyecto/sprintsMas$', views.sprintsMas, name='sprintsMas'),
